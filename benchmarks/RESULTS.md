...
- **Timestamp:** 2026-09-22T01:40:44.993Z
- **Node:** `v26.8.2`
...
| Latency p95 | 0.034 ms |
| Latency p99 | 0.064 ms |
...
| --- | --- |
| Probes | 6 |
| Expected unsafe probes | 5 |
| Expected clean probes | 1 |
| Matched expected result | 6 |
